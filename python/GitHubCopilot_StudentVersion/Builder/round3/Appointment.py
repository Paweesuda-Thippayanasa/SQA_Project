...
class Appointment:
    def __init__(self, doctor_name, patient_name, appointment_type, appointment_datetime, note, creator_name, clinic_contact):
    ...
    def __str__(self):
        return (f"Appointment with Dr. {self.doctor_name} for {self.patient_name} "
                f"on {self.appointment_datetime} for {self.appointment_type}. "
                f"Note: {self.note}. Created by {self.creator_name}. "
...
class AppointmentBuilder:
    ...
    def reset(self):
        ...
        self._appointment_datetime = None
        self._note = None
    ...
    def build(self):
        return Appointment(self._doctor_name, self._patient_name, self._appointment_type, self._appointment_datetime, self._note, self._creator_name, self._clinic_contact)

class Director:
    def __init__(self, builder):
        self._builder = builder

    def construct_tooth_extraction(self, doctor_name, patient_name, appointment_datetime, note, creator_name, clinic_contact):
        return (self._builder.reset()
                .set_doctor_name(doctor_name)
                .set_patient_name(patient_name)
                .set_appointment_type("Tooth Extraction")
                .set_appointment_datetime(appointment_datetime)
                .set_note(note)
                .set_creator_name(creator_name)
                .set_clinic_contact(clinic_contact)
                .build())

    def construct_monthly_rubber_band_change(self, doctor_name, patient_name, appointment_datetime, note, creator_name, clinic_contact):
        return (self._builder.reset()
                .set_doctor_name(doctor_name)
                .set_patient_name(patient_name)
    ...
    def construct_removal_of_braces(self, doctor_name, patient_name, appointment_datetime, note, creator_name, clinic_contact):
        return (self._builder.reset()
                .set_doctor_name(doctor_name)
                .set_patient_name(patient_name)
    ...
    def construct_fitting_of_braces(self, doctor_name, patient_name, appointment_datetime, note, creator_name, clinic_contact):
        return (self._builder.reset()
                .set_doctor_name(doctor_name)
                .set_patient_name(patient_name)
